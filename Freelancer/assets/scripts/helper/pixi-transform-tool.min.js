...
(function () {
    ...
    TransformTool.prototype.apply = function (target) {
        ...
        for (var i = 0; i < 4; i++) {
            ...
            var p = GPixi.createSpriteWithCallback(path_resource + "images/icon-scale-bg.png", function (sprite) {
                sprite.width = sprite.height = scope.CONTROL_SIZE * 3 / scope.RELATIVE_SCALE;
            });
            p.anchor.set(0.5, 0.5);
            //p.pivot.set(scope.CONTROL_SIZE / scope.RELATIVE_SCALE, scope.CONTROL_SIZE / scope.RELATIVE_SCALE);
            p.id = i;
            p.rotation = GMath.degToRad(90 * i);
        ...
        var rotateControl = GPixi.createSpriteWithCallback(path_resource + "images/icon-rotate-bg.png", function (sprite) {
            sprite.width = sprite.height = scope.CONTROL_SIZE * 4 / scope.RELATIVE_SCALE;
        });
        ...
        var rotateControl2 = GPixi.createSpriteWithCallback(path_resource + "images/icon-rotate-bg.png", function (sprite) {
            sprite.width = sprite.height = scope.CONTROL_SIZE * 4 / scope.RELATIVE_SCALE;
        });
        ...
        var rotateControl3 = GPixi.createSpriteWithCallback(path_resource + "images/icon-rotate-bg.png", function (sprite) {
            sprite.width = sprite.height = scope.CONTROL_SIZE * 4 / scope.RELATIVE_SCALE;
        });
        ...
        var rotateControl4 = GPixi.createSpriteWithCallback(path_resource + "images/icon-rotate-bg.png", function (sprite) {
            sprite.width = sprite.height = scope.CONTROL_SIZE * 4 / scope.RELATIVE_SCALE;
        });
        rotateControl4.name = "rotateControl4";

        rotateControl.anchor.set(0.5, 0.5);
        rotateControl2.anchor.set(0.5, 0.5);
        rotateControl3.anchor.set(0.5, 0.5);
        rotateControl4.anchor.set(0.5, 0.5);
    ...
    TransformTool.prototype._positionControls = function () {
        ...
        var rotateControlSpace = 25;

        tool.rotateControl.position.x = -target.width * (target.pivotPercent.x) - rotateControlSpace;
        tool.rotateControl.position.y = target.height * -(target.pivotPercent.y) - rotateControlSpace;

        tool.rotateControl2.position.x = target.width * (1 - target.pivotPercent.x) + rotateControlSpace;
        tool.rotateControl2.position.y = target.height * -(target.pivotPercent.y) - rotateControlSpace;

        tool.rotateControl3.position.x = target.width * (1 - target.pivotPercent.x) + rotateControlSpace;
        tool.rotateControl3.position.y = target.height * (1 - target.pivotPercent.y) + rotateControlSpace;

        tool.rotateControl4.position.x = -target.width * (target.pivotPercent.x) - rotateControlSpace;
        tool.rotateControl4.position.y = target.height * (1 - target.pivotPercent.y) + rotateControlSpace;
    }
